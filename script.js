document.addEventListener('DOMContentLoaded', () => {
    ...
    ws.onmessage = (event) => {
        ...
        console.log('msg_type:', data.msg_type, 'Conteúdo:', data);
        ...
        if (data.msg_type === 'ticks_history') {
          if (data.candles) {
            console.log('Candles recebidos:', data.candles);
    ...
    function processCandlesData(candles) {
      ...
      let direcao = (parseFloat(lastCandle.close) > parseFloat(lastCandle.open)) ? "CALL" : "PUT";
    ...
    buscarSinaisButton.addEventListener('click', (e) => {
      ...
      // Converte o par de moedas para o formato da Deriv API (ex.: "EUR/USD" -> "frxEURUSD")
